...
namespace SaveForPerksAPI.Migrations
{
    ...
    [Migration("20260206164436_AddRewardOwnerCategory")]
    partial class AddRewardOwnerCategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SaveForPerksAPI.Entities.RewardOwnerCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasKey("Id")
                        .HasName("PK__reward_owner_category__id");

                    b.HasIndex(new[] { "Name" }, "UQ__reward_owner_category__name")
                        .IsUnique();

                    b.ToTable("reward_owner_category", (string)null);
            ...
            modelBuilder.Entity("SaveForPerksAPI.Entities.RewardOwner", b =>
                {
                    b.HasOne("SaveForPerksAPI.Entities.RewardOwnerCategory", "Category")
                        .WithMany("RewardOwners")
